    ...
    return (
        <div className='overflow-x-hidden'>
            ...
            <div className='pt-[80px] '>
                <h1 className='text-white text-[26px] text-center font-bold'>Global Events</h1>
                <div className='mt-9 text-[12px] text-center text-[rgb(96,92,115)] font-bold font-sans'>
                ...
                <div className='mt-6 ml-6 text-white'>
            ...
            <div className=' w-[86%] overflow-x-auto m-auto'>
                ...
                <div className='overflow-x-hidden'>
                    <div className=' flex gap-2 motion '>
                        ...
                        <div className='mt-12 shrink-0'>
                            <img className='w-36' src={img7} alt="" />
                        </div>
                        <div className='mt-12 shrink-0'>
