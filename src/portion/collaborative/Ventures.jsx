...
const Ventures = () => {
    return (
        <div>
            ...
            <div className='w-[95%] mt-20 p-6 rounded-[35px] bg-[rgb(26,19,55)] m-auto flex flex-wrap gap-6 justify-center lg:justify-around '>
                <div>
                    ...
                    <div className='text-[rgb(188,187,197)] text-[13px] mt-10 lg:text-[19px] '>
                    ...
                    <div className='mt-10 flex gap-16 '>
                        <div className='flex'>
                            ...
                            <div className='ml-2'>
                                ...
                                <p className=' text-[9.5px] text-[rgb(188,187,197)] mt-1 lg:text-[17px]'>Dedicated <br /> professionals</p>
                            </div>
                        </div>
                        ...
                        <div className='flex'>
                            ...
                            <div className='ml-2'>
                                ...
                                <p className=' text-[9.5px] text-[rgb(188,187,197)] mt-1 lg:text-[17px]'>Customer <br /> Support</p>
                            </div>
                        </div>
                        ...
                        <div className='flex'>
                            ...
                            <div className='ml-2'>
                                ...
                                <p className=' text-[9.5px] text-[rgb(188,187,197)] mt-1 lg:text-[17px]'>Around <br /> the world </p>
                            </div>
                        </div>
                    </div>
